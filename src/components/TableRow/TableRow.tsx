  ...
  if (!mobile) {
      ...
      <SC.Row key={row.id} onClick={(e) => handleClick(e)}>
        ...
        {integrationsTable || connectorsTable ? (
          <TableCell align="left">
            {installs?.data.total !== undefined ? installs?.data.total : <CSC.Spinner />}
          </TableCell>
        ) : (
          <>
            <TableCell component="th" scope="row">
    ...
    return (
      <SC.Row key={row.id} onClick={(e) => handleClick(e)}>
        ...
        <TableCell align="left">
          {integrationsTable ? (
            selectedCell === IntegrationCells.INSTALLS && installs?.data.total !== undefined ? (
              installs?.data.total
            ) : (
              <CSC.Spinner />
            )
